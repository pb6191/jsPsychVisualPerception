...
jsPsych.plugins['categorize-html-space'] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'categorize-html-space',
    description: '',
    parameters: {
      stimulus: {
      ...
      feedback_answer: {
        type: jsPsych.plugins.parameterType.KEY,
        pretty_name: 'Feedback answer',
        default: undefined,
        description: 'The key to indicate the feedback response.'
      },
      choices: {
        type: jsPsych.plugins.parameterType.KEY,
        pretty_name: 'Choices',
    ...
    function doFeedback(correct, timeout) {
      ...
      if (trial.force_correct_button_press && ((timeout && trial.show_feedback_on_timeout) || !timeout)) {
        ...
        jsPsych.pluginAPI.getKeyboardResponse({
          ...
          valid_responses: [trial.feedback_answer],
          rt_method: 'performance',
          persist: false,
          allow_held_key: false
        });
